export const SPEAKERS_DATA = [
  ...
  },
  {
    ...
    socials: [
      {
        Linkedin: "moray-venkata-sahitya🇮🇳-956667290",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    desc: "Mrs. Kavitha Lakshminarasaiah, an MS graduate from the USA, is a Cloud Engineer with over 15 years of IT experience. She is a seasoned career coach, an influenƟal voice on Instagram and LinkedIn, and was featured on the Times Square New York Billboard in 2025. A recipient of the 2024 Manuel Carballo Governor's Award (USA), she is also the founder of the Lakshya Foundation in India, dedicated to children's health and education.",
    socials: [
      {
